...
function App() {
  ...
  return (
   ...
   <div className="modal-content">
    ...
    <label>Enter your Email-ID <input required type = 'email' placeholder = "Enter your Email" onChange = {(e) =>  {
      setFormData((prev) => {
        return {
          ...prev,
    ...
    <label>Enter your Date OF Joining <input required type = 'date' placeholder = "DoJ" onChange = {(e) =>  {
      setFormData((prev) => {
        return {
          ...prev,
          doj:e.target.value
...
<caption> <strong>New Hiring Details</strong></caption>
  ...
  </tr>
  {
    ...
    <span className="close" onClick = {() => HandleDelete(index)}>&times;</span>
      </tr>
      );
    })
  }
